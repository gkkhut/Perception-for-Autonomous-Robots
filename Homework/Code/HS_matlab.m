...
video = VideoWriter('D:\Perception Assignments\Homework\Output_Part2\Matlab_HS_Grove_output\Matlab_HS_Grove');
video.FrameRate = 5;
output = 'D:\Perception Assignments\Homework\Output_Part2\Matlab_HS_Grove_output\';
open(video);
...
fileout = sprintf('Matlab_HS_Grove_out%02d.jpg', l);
