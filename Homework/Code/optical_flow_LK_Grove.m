...
video = VideoWriter('Grove_LK','MPEG-4');
video.FrameRate = 1;
open(video);

framepath = 'D:\Perception Assignments\Homework\eval-gray-allframes\eval-data-gray\Grove\frame';
output = 'D:\Perception Assignments\Homework\Output_Grove\';
...
fileout = sprintf('Grove_out%02d.jpg', l);
